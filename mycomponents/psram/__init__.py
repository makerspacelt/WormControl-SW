...
async def to_code(config):
    ...
    if CORE.using_esp_idf:
        ...
        # add_idf_sdkconfig_option("CONFIG_SPIRAM_USE_CAPS_ALLOC", True) # esphome default
        add_idf_sdkconfig_option("CONFIG_SPIRAM_USE_MALLOC", True)
        # add_idf_sdkconfig_option("CONFIG_SPIRAM_CACHE_WORKAROUND", True) # TODO enable if observing crashes
